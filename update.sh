...
node ./scripts/summarise_area.js datadir="${DATADIR}" code_name='PARISH_CODE' uprn_lookup="${UPRN_LOOKUP}" json_output="${JSON_OUTPUT}" xlsx_output="${XLSX_OUTPUT}"
# summary epcs by ward
JSON_OUTPUT="${SUMMARY_DIR}/summary_by_ward.json"
XLSX_OUTPUT="${SUMMARY_DIR}/summary_by_ward.xlsx"
node ./scripts/summarise_area.js datadir="${DATADIR}" code_name='WARD_CODE' uprn_lookup="${UPRN_LOOKUP}" json_output="${JSON_OUTPUT}" xlsx_output="${XLSX_OUTPUT}"
